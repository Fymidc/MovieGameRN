                ...
                return label === "HomeTab" ? (
                    ...
                    >
                        ...
                        <View style={{ alignItems: "center", justifyContent: "center", paddingTop: 10 }} >
                            <IonIcons style={{ color: isFocused ? 'white' : 'grey' }} size={28} name={isFocused ? 'home' : 'home-outline'} />
                            <Octicons style={{ color: isFocused ? 'white' : '#121212' }} size={18} name='dash' />
                    ...
                    >
                        ...
                        {label === "Settings" &&
                            <View style={{ alignItems: "center", justifyContent: "center", paddingTop: 10 }}  >
                                ...
                                <IonIcons style={{ color: isFocused ? 'white' : 'grey' }} size={28} name={isFocused ? 'settings' : 'settings-outline'} />
                                <Octicons style={{ color: isFocused ? 'white' : '#121212' }} size={18} name='dash' />
                            </View>
                        }
                    ...
                    >
                        {label === "ProfileTab" &&
                            <View style={{ alignItems: "center", justifyContent: "center", paddingTop: 10 }} >
                                ...
                                <IonIcons style={{ color: isFocused ? 'white' : 'grey' }} size={28} name={isFocused ? 'person' : 'person-outline'} />
                                <Octicons style={{ color: isFocused ? 'white' : '#121212' }} size={18} name='dash' />
                            </View>
